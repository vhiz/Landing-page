  ...
  return (
    ...
    >
      <div className="flex-[2.5] h-full">
        <div
          className={`relative w-full h-[40%] lg:h-[60%] border-[4px] border-secondary overflow-hidden rounded-lg ${
        ...
        >
          ...
          <div className="mt-3 flex gap-5">
            <div className="card max-w-lg text-justify font-thin text-xs md:text-sm italic">
              ...
              found absent. <br  className="hidden md:block"/> After several attempts to solve the problem,
              we learned that her family depends on what she makes from hawking
              to feed.
            </div>
            <div className="card max-w-lg text-justify text-xs md:text-sm">
      ...
      <div
        className={`flex-1 hidden md:flex flex-col gap-5 ${
          inView
            ? "animate-fadeInRight animate-delay-[0.5s]"
            : "animate-fadeOutLeft"
        }`}
      >
        <div className="flex gap-1 justify-center text-sm lg:text-base font-thin">
        ...
        <div className="flex gap-1 text-sm lg:text-base font-thin">
