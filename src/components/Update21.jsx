    ...
    <section id="update" className="flex p-3" ref={intersectionRef}>
      <div className="flex-1">
        ...
        >
          ...
          <div className="flex-[2] relative rounded-md overflow-hidden h-full">
            <img
              src="/img12.jpg"
              alt=""
        ...
        >
          ...
          >
            <h2 className="text-lg font-semibold">Save Acclearn Campaign</h2>
            <span className="mt-2 italic text-xs">
      ...
      <div className="flex-1">
        ...
        >
          ...
          >
            <h2 className="text-lg font-semibold">Partnership with JDI</h2>
            <span className="mt-2 italic text-xs">
        ...
        >
          ...
          >
            <h2 className="text-lg font-semibold">Celebrating Earth Day</h2>
            <span className="mt-2 italic text-xs">
